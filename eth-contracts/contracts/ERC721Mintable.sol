...
contract Ownable {
    ...
    event OwnerChanged(address latestOwner);
    ...
    function transferOwnership(address latestOwner) public onlyOwner {
        // TODO add functionality to transfer control of the contract to a newOwner.
        // make sure the new owner is a real address
        
        //**LVC
        require(latestOwner != _owner, "New owner cannot be the current owner");
        require(latestOwner == address(latestOwner), "Owner is a real address");
        _owner = latestOwner;
        emit OwnerChanged(_owner);
    }
}
...
contract Pausable is Ownable{
    ...
    function setPaused(bool pauseValue) public onlyOwner whenNotPaused{
        _paused = pauseValue;
        emit Paused();
    }
}
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        //**LVC
        require(to != ownerOf(tokenId), "Address already owns the token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        //**LVC
        require(msg.sender == getOwner()  || isApprovedForAll(ownerOf(tokenId), msg.sender), "Approval not Authorised");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        //**LVC
        require(!_exists(tokenId), "Token already exists - cannot mint again");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        //**LVC
        require (from == _tokenOwner[tokenId], "Token transfer can only be performed by owner");

        // TODO: require token is being transfered to valid address
        //**LVC
        require(!to.isContract(), "to address has to be valid");
...
//**LVC
contract LVCToken is ERC721Metadata{
    string private _name = "LVCToken";
